...
public class Bancomat {
    ...
    public void addMoney(int amount20, int amount50, int amount100) {
        this.amount20 = this.amount20 + amount20;
        this.amount50 = this.amount50 + amount50;
        this.amount100 = this.amount100 + amount100;
    }
    ...
    public boolean withdraw(int amount) {
        if (amount > (amount20 * 20 + amount50 * 50 + amount100 * 100)) {
            ...
            System.out.println("наш банкомат не выдает купюры номиналом менее 5, введите другую сумму");
            return false;
        } 
