...
public class Task1 {
    ...
    public static void main(String[] args) {
        ...
        if (firstLocalDate.isBefore(secondLocalDate)) {
            out.println(firstLocalDate + " меньше " + secondLocalDate);
        } else if (firstLocalDate.isAfter(secondLocalDate)) {
            out.println(firstLocalDate + " больше " + secondLocalDate);
        } else {
            out.println(firstLocalDate + " равна " + secondLocalDate);
        }
    }
}
